        ...
        while True:
            ...
            if self.process_this_frame:
                ...
                for face_encoding in self.face_encodings:
                    ...
                    #connects to the database and writes to the attendance table
                    connection = connect_to_db()
                    table_name = create_daily_attendance_table(connection)
                    for searchid in self.face_names:
                        ...
                        if not student_record.empty:
                            ...
                            create_attendance_record(connection, table_name, student_id, first_name, last_name, section)
